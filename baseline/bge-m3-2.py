...
# "finnish", "indonesian", "korean", "japanese","english", "swahili", "thai","telugu","bengali",
...
embedding_dir = os.path.join("/home/sunga/Desktop/Code/runs/bge-m3", "embeddings")
...
for lang in langs:
    ...
    output_dir = "/home/sunga/Desktop/Code/runs/bge-m3"
    os.makedirs(output_dir, exist_ok=True)

    # TREC 파일 저장
    output_file = os.path.join(output_dir, f"run.mrtydi.{lang}.bge-m3.trec")
    ...
    with open(output_file, "w") as fout:
        for idx, retrieved in enumerate(I):
            ...
            for rank, doc_idx in enumerate(retrieved):
                fout.write(f"{qid} Q0 {doc_ids[doc_idx]} {rank+1} {D[idx][rank]:.4f} BGE-M3\n")

    # JSONL 파일 저장
    jsonl_file = os.path.join(output_dir, f"run.mrtydi.{lang}.bge-m3.jsonl")
...
print("\n✅ All Mr.TyDi languages processed with BGE-M3 (with cached embeddings, TREC and JSONL outputs).")



# nohup python bge-m3-2.py > bge-m3-2.out 2>&1 &